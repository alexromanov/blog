...
For our example, we will use simple gRPC service implementation from one of the [previous blog post](https://testengineeringnotes.com/ua/posts/2021-06-12-scala-grpc-api-tests/). 
