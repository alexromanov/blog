...
summary: "One forgotten aspect of using AI for testing and learning"
tags: [ai]
categories: [post]
---
...
But another problem is **how software testers use AI now**. For many of us, ***AI looks like a magic prediction ball that answers our questions***. But are these answers correct and complete? How can we find it out? Especially, when you are learning new concepts from a new domain, such as automation, programming, or a shiny new instrument that *"will eliminate manual testing once again"*. 
...
The main advice for improving understanding while learning with AI is ... ***do not ask just "Explain me a term X"***. 
...
Otherwise, we build castles on the sand. Castles with the name "shallow understanding". Anyone can break these castles with one simple question: *Are you sure about that?*