...
In one of the [previous blog posts](https://testengineeringnotes.com/en/posts/2021-05-17-scala-allure-report/), I showed how to add Allure reporting to the Scala-based automation project.  
...
2. As email action connects to Gmail for sending emails - make sure that [security policies allow](https://testengineeringnotes.com/en/posts/2021-05-05-scala-mail-testing/) to do it for external resources
