...
pubDate: 2020-05-03T09:00:00+03:00
...
![format ui](../../../assets/images/posts/20200503/format-ui.png)

and returns a result:

![format result](../../../assets/images/posts/20200503/format-result-ui.png)

For API part the same functionality is implemented for an "/format" endpoint:

![post request](../../../assets/images/posts/20200503/post-request.png)

The result object is:

![post response](../../../assets/images/posts/20200503/post-response.png)
...
![parametrized](../../../assets/images/posts/20200503/parameterized-result.png)
