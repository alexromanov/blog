...
- _BaseStepListener_ class which implements _StepListener_ interface has been added in 1.2.x version;
- It is possible to write your own implementation of _StepListener_ interface or use _BaseStepListener_;
- _BaseStepListener_ has a _CloseBrowser_ class, which has a functionality to close browser depending on current configuration;
- Configuration for browser restart is implemented via _RestartBrowserForEach_ enum;
