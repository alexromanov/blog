...
![Project Structure](../../../assets/images/posts/20210612/grpc.png)
...
4. Generate gRPC clients from proto files. As our build system in sbt, you need to execute the command
   ...
   As a result, all clients generated from proto file can be found at _/target/scala-2.13/akka-grpc/main_ folder.
