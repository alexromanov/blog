...
![Project Structure](../../../assets/images/posts/20220501/hash-function.png)
...
The two main properties of the hash function are **ease of computation** and **determinism** (_the same input data should always result in the same hash_).
...
![Project Structure](../../../assets/images/posts/20220501/sha-2.png)
