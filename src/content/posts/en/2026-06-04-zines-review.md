---
title: 'Book Review: Wizard Zines'
...
toc: true
heroImage: ../../../assets/images/posts/20260604/zines-cover.png
heroAlt: 'Wizard zines cover'
---

## From blog to .... comic books?

Once upon a time, searching an internet I found a blog post about an [importance of brag document](https://jvns.ca/blog/brag-documents/). I really liked the idea and the way how it was described. The [blog](https://jvns.ca/) was by Julia Evans. She was an engineer at Stripe and talked about technical things very easy and engaging.

Here are a few blog posts to read:
...
Then, I discovered that Julia wrires Wizard Zines. It's a short comic books about technical topics. 

![Project Structure](../../../assets/images/posts/20260604/tcpdump.png)
...
The value of **[Wizard Zines](https://wizardzines.com/)** is that here you will find the main things you might need in practice. The rest you can explore by your own. 

## One thing I learned from each Wizard Zine

### Bite Size series...

![Project Structure](../../../assets/images/posts/20260604/linux.png)
...
- [The Pocket Guide to Debugging](https://wizardzines.com/zines/debugging-guide/) - actionable advices on how to find the root causes of unreproducible bugs
- [How Containers Work!](https://wizardzines.com/zines/containers/) - two ways to block scary program calls: by limiting contaner's capability or by setting `seccomp-bpf` whitelist
...
![Project Structure](../../../assets/images/posts/20260604/network.png)
...
- [Networking! ACK!](https://wizardzines.com/zines/networking/) - how to see TCP handshare `sudo tcpdump host blabla.com`
...
- [So you want to be a wizard](https://wizardzines.com/zines/wizard/) - it's ok to don't know something, even if you are senior engineer
- [Spying on your programs with strace](https://wizardzines.com/zines/strace/) `strace` is on Linux. On OSX are `dtruss` or `dtrace`
...
[Wizard Zines](https://wizardzines.com/) is fun and interesting way how to present technical information and how to learn new things. It's not substitute for a book or a manual of the tool of your choice.

But Zines are full of practical hacks and advices you can get from a senior engineer. I found a lot of useful info here. I hope you can find it too.

> P.S. As always - check the content. Maybe you don't need to learn about Linux commandline, tracing tools and Docker. Then the majority of tools mentioned in zines will not be applicable to you. 
